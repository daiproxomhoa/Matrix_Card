...
class Avatar extends Container {
    constructor() {
        ...
        this.sex = true;
        this.name = "";
        this.show = (gold, sex, number, name, id, isReady) => {
            if (!util_1.isNullOrUndefined(number && name && sex && gold && id)) {
                ...
                this.attack = PIXI.Sprite.fromImage(App_1.App.AssetDir + "Picture/Icon/Attack.png");
                this.die = PIXI.Sprite.fromImage(App_1.App.AssetDir + "Picture/Icon/die.png");
                ...
                this.attack.alpha = 0;
                this.die.alpha = 0;
                this.yes = PIXI.Sprite.fromImage(App_1.App.AssetDir + "Picture/Icon/yes.png");
                this.no = PIXI.Sprite.fromImage(App_1.App.AssetDir + "Picture/Icon/no.png");
                this.yes.width = 150;
                this.yes.height = 150;
                this.no.width = 150;
                this.no.height = 150;
                this.yes.alpha = 0;
                this.no.alpha = 0;
                this.dec = PIXI.Sprite.fromImage(App_1.App.AssetDir + "Picture/Icon/dectection.png");
                this.dec.alpha = 0;
                this.ready = PIXI.Sprite.fromImage(App_1.App.AssetDir + "Picture/Icon/ready.png");
                this.ready.alpha = rd;
